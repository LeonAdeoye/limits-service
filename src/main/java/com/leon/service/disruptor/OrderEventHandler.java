...
public class OrderEventHandler implements EventHandler<OrderEvent>
{
    ...
    {
        Optional<Trader> trader = traderNotionalLimitService.findTraderByUserId(order.getOwnerId());
        if (!trader.isPresent())
        {
        ...
        TraderNotionalLimit traderNotionalLimit = traderNotionalLimitService.getTraderNotionalLimit(trader.get().getTraderId());
        ...
        Optional<Desk> desk = deskNotionalLimitService.findDeskByTraderId(traderNotionalLimit.getTraderId());
        if (!desk.isPresent())
        {
        ...
        DeskNotionalLimit deskNotionalLimit = deskNotionalLimitService.getDeskNotionalLimit(desk.get().getDeskId());
    ...
    private void publishTraderNotionalUpdate(TraderNotionalLimit traderNotionalLimit, Side side, double notionalValueUSD)
    {
        try
        {
            ...
            DeskNotionalLimit deskNotionalLimit = deskNotionalLimitService.getDeskNotionalLimit(desk.getDeskId());
    ...
    private String createBreachMessage(String breachType, DeskNotionalLimit deskNotionalLimit, Order order, int limitPercentage)
    {
        try
        {
            ...
            breachDetails.put("traderName", traderNotionalLimitService.findTraderFullNameByUserId(order.getOwnerId()));
